...
import { I as InvalidArgumentError$1, a as APICallError$1, b as LoadAPIKeyError$1, T as TypeValidationError$1, E as EmptyResponseBodyError$1, J as JSONParseError$1, U as UnsupportedFunctionalityError$1, N as NoSuchModelError, c as TooManyEmbeddingValuesForCallError, d as InvalidResponseDataError$1, e as InvalidPromptError$1, M as MastraBase } from './index2.mjs';
import { s as safeParseAsync, t as toJSONSchema, q as object, o as boolean, p as array, i as string, u as union, v as literal, n as number, x as discriminatedUnion, y as looseObject, w as unknown, r as record, es as _enum, f7 as tuple, ef as any, l as lazy } from './schemas.mjs';
  ...
  try {
    ...
    if (!response.ok) {
      ...
      try {
        ...
        if (isAbortError$6(error) || APICallError$1.isInstance(error)) {
          throw error;
        }
  ...
  try {
    ...
    if (!response.ok) {
      ...
      try {
        ...
        if (isAbortError$5(error) || APICallError$1.isInstance(error)) {
          throw error;
        }
        throw new APICallError$1({
          message: "Failed to process error response",
  ...
  try {
    ...
    if (!response.ok) {
      ...
      try {
        ...
        if (isAbortError$4(error) || APICallError$1.isInstance(error)) {
          throw error;
        }
        throw new APICallError$1({
          message: "Failed to process error response",
  ...
  try {
    ...
    if (!response.ok) {
      ...
      try {
        ...
        if (isAbortError$3(error) || APICallError$1.isInstance(error)) {
          throw error;
        }
        throw new APICallError$1({
          message: "Failed to process error response",
